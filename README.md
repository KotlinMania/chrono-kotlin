# chrono-kotlin in Kotlin

[![GitHub link](https://img.shields.io/badge/GitHub-KotlinMania%2Fchrono--kotlin-blue.svg)](https://github.com/KotlinMania/chrono-kotlin)
[![Maven Central](https://img.shields.io/maven-central/v/io.github.kotlinmania/chrono-kotlin)](https://central.sonatype.com/artifact/io.github.kotlinmania/chrono-kotlin)
[![Build status](https://img.shields.io/github/actions/workflow/status/KotlinMania/chrono-kotlin/ci.yml?branch=main)](https://github.com/KotlinMania/chrono-kotlin/actions)

This is a Kotlin Multiplatform line-by-line transliteration port of [`chronotope/chrono`](https://github.com/chronotope/chrono).

**Original Project:** This port is based on [`chronotope/chrono`](https://github.com/chronotope/chrono). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
## Upstream README — `chronotope/chrono`

> The text below is reproduced and lightly edited from [`https://github.com/chronotope/chrono`](https://github.com/chronotope/chrono). It is the upstream project's own description and remains under the upstream authors' authorship; links have been rewritten to absolute upstream URLs so they continue to resolve from this repository.
...
This Kotlin port is distributed under the same MIT license as the upstream [`chronotope/chrono`](https://github.com/chronotope/chrono). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.

Original work copyrighted by the chrono authors.  
Kotlin port: Copyright (c) 2026 Sydney Renee and The Solace Project.

### Acknowledgments

Thanks to the [`chronotope/chrono`](https://github.com/chronotope/chrono) maintainers and contributors for the original Rust implementation. This port reproduces their work in Kotlin Multiplatform; bug reports about upstream design or behavior should go to the upstream repository.
