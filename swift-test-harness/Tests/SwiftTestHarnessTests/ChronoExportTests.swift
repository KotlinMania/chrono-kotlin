...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Chrono.swiftmodule/`
...
//      `import Chrono` above would fail at compile time.
//
//   2. The static archive `libChrono.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Chrono" }` and
//      `flattenPackage = "io.github.kotlinmania.chrono"` configuration in
