...
kotlin {
    ...
    swiftExport {
        moduleName = "Chrono"
        flattenPackage = "io.github.kotlinmania.chrono"
    }

    android {
        namespace = "io.github.kotlinmania.chrono"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "chrono-kotlin", version.toString())

    pom {
        name.set("chrono-kotlin")
        description.set("Kotlin Multiplatform port of chronotope/chrono - Date and time library for Rust")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/chrono-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/chrono-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/chrono-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/chrono-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.chrono.codeql
