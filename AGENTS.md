...
This file is the quick-reference operating contract for chrono-kotlin. The longer
...
chrono-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`chrono`](https://crates.io/crates/chrono). Upstream Rust is the behavioral oracle while the
